#  LAMP + Redis stack template
    

A basic LAMP + Redis stack environment built using Docker Compose to use in my/your development projects. It consists of the following:
...
```shell
git clone https://github.com/julianobressan/lampr-stack-template.git
